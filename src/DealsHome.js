...
class DealsHome extends PureComponent {
 ...
 render(){
    return (
      <View style={{flex:1, backgroundColor:'white'}}>
        <ScrollView>
            <Text style={{paddingTop: 10, paddingBottom: 10, color: 'brown', fontSize: 20, alignSelf: 'center'}}>Deals</Text>
            <Deals handleSelect={this.handleSelect}/>
        </ScrollView>
     </View>
    )
  }
